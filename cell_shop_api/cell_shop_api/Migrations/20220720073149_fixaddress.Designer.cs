...
namespace cell_shop_api.Migrations
{
    ...
    [Migration("20220720073149_fixaddress")]
            ...
            modelBuilder.Entity("CellShop_Api.Models.Invoice", b =>
                {
                    ...
                    b.Property<DateTime>("DateInvoice")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 20, 14, 31, 48, 828, DateTimeKind.Local).AddTicks(5586));
            ...
            modelBuilder.Entity("CellShop_Api.Models.Log", b =>
                {
                    ...
                    b.Property<DateTime>("Time")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 7, 20, 14, 31, 48, 832, DateTimeKind.Local).AddTicks(3712));
