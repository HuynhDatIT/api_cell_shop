        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PathLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_modelProducts_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_modelProducts_Categories_CategorieId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_modelProducts_ModelProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BannerImages_Products_ProductId",
            ...
            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Id", "AvatarPath", "Birthday", "Email", "FullName", "Male", "PassWord", "RoleId", "UserName" },
                values: new object[,]
                {
                    { 1, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", "Huynh Tan Dat", false, "827ccb0eea8a706c4c34a16891f84e7b", 1, "admin" },
                    { 3, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "user2@gmail.com", "Huynh Tan Dat", false, "827ccb0eea8a706c4c34a16891f84e7b", 1, "user2" },
                    { 2, null, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "user1@gmail.com", "Nguoi dung 1", false, "827ccb0eea8a706c4c34a16891f84e7b", 2, "user1" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 1, "Đây là mô tả của sp", "Iphone 12", "{Màn hình: '12 inch'}" },
                    { 2, 2, 1, "Đây là mô tả của sp", "Note 21 Ultra", "{Màn hình: '12 inch'}" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Carts",
                columns: new[] { "Id", "AccountId", "ProductId", "Quantity" },
                values: new object[,]
                {
                    { 1, 2, 1, 1 },
                    { 2, 2, 2, 1 },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "Day la review1", 1, 3f },
                    { 2, 2, "Day la review2", 1, 4f }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BannerImages_ProductId",
                table: "BannerImages",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_modelProducts_BrandId",
                table: "modelProducts",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_modelProducts_CategorieId",
                table: "modelProducts",
                column: "CategorieId");
